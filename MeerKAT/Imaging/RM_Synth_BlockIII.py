...
def create_parameterfile(sourcename):
    with open(f'{sourcename}_rmsynth.par','w') as file:
        ...
        file.write('\n')
        file.write(f'input_dir /net/rijn9/data2/swart/DATA/MeerKAT_DATA/Imaging/Block_III/')
        file.write('\n')


calculate_rms(sourcename = 'BC_III', channels =25)
create_inverse_variance_weights(sourcename = 'BC_III')
create_parameterfile(sourcename = 'BC_III')

#run = "python /net/bovenrijn/data1/digennaro/software/pyrmsynth/rmsynthesis.py -s"+"BC_III_rmsynth.par"
#os.system(run)
